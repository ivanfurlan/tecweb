        ...
        <form action="prenotavisita.php" method="post">
            <div class="colonna1">
                <fieldset>
                    ...
                    <button type="button" onclick="">Controlla disponibilit&agrave;</button>
                </fieldset>
            </div>
            ...
            <div class="colonna2">
                <fieldset>
                    ...
                    <input type="radio" name="orario" id="ore8" value="8:00" checked="checked" />
                    <label for="ore8">Ore 8:00-9:00</label>

                    <input type="radio" name="orario" id="ore9" value="9:00" disabled="disabled" />
                    ...
                    <input type="radio" name="orario" id="ore16" value="16:00" disabled="disabled" />
