<!-- PAGINA CHE PER ESEMPIO VIENE CHIAMATA QUANDO LA CONNESSIONE AL DATABASE FALLISCE -->

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="it" lang="it">

<head>
    <title>404 - Dott. Marco Donati</title>
...
<body>
    ...
    <div id="main">
        <h1>Ci dispiace! Si è verificato un errore.</h1>
        <p>
            Riprova più tardi, oppure contatta un amministratore del sito.
        </p>
    </div>
